...
import com.Aaron.test1.block.BlockTestMetalBlock;
...
public class ModBlocks {
    ...
    public static final BlockTestMetalBlock testmetalblock = new BlockTestMetalBlock();

    public static void init() {
        GameRegistry.registerBlock(testore, "testore");
        GameRegistry.registerBlock(testmetalblock, "testmetalblock");
    }
}
